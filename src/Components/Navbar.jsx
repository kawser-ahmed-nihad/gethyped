...
const Navbar = () => {
    ...
    return (
        <div className={`flex  transition-transform duration-300 bg-transparent items-center justify-between max-w-7xl  mx-auto py-4 px-6 ${visible ? 'translate-y-0' : '-translate-y-full'}`} >
            <div className='w-12 h-12 z-50'>
  ...
  `}
            ...
            >
                <div className="bg-white rounded-2xl h-screen shadow-xl mx-2 p-6">

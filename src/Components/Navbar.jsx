...
const Navbar = () => {
    ...
    return (
        <div className={`flex transition-transform duration-300 bg-transparent items-center justify-between max-w-7xl mx-auto py-4  ${visible ? 'translate-y-0' : '-translate-y-full'}`} >
            ...
            <div className=''>
                <ul className='flex items-center space-x-1 py-2 px-3 rounded-xl bg-[#ffffff] font-semibold text-sm'>
                    <li>
